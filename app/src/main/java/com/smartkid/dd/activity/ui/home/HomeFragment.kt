...
class HomeFragment : Fragment(), RecentViewAdapter.ListItemClickListener, PopularAdapter.ListItemClickListener {
    ...
    private fun popularViewRecycler() {
        ...
        popularCardList.add(PopularHelper(R.drawable.ic_dashboard_black_24dp, "Guess Instrument", "the goal of this game is to guess any instrument proposed by the app"))
        popularCardList.add(PopularHelper(R.drawable.ic_dashboard_black_24dp, "Sounds Animals", "Guess what animal is that sound"))
        popularCardList.add(PopularHelper(R.drawable.ic_dashboard_black_24dp, "Answer the response", "this is QCM game to improve children's knowledge"))
        popularCardList.add(PopularHelper(R.drawable.ic_dashboard_black_24dp, "Calcul", "Best game to improve mental calculation"))
