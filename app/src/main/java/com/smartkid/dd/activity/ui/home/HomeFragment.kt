...
class HomeFragment : Fragment(), RecentViewAdapter.ListItemClickListener, PopularAdapter.ListItemClickListener {
    ...
    private fun recentViewRecycler() {
        ...
        recentViewlocations.add(RecentViewHelper(gradient1, R.drawable.ic_dashboard_black_24dp, "Animaux"))
        recentViewlocations.add(RecentViewHelper(gradient4, R.drawable.ic_dashboard_black_24dp, "Pays"))
        recentViewlocations.add(RecentViewHelper(gradient2, R.drawable.ic_dashboard_black_24dp, "Instrument de musique"))
        recentViewlocations.add(RecentViewHelper(gradient4, R.drawable.ic_dashboard_black_24dp, "Lettre et Nombre"))
    ...
    private fun popularViewRecycler() {
        ...
        popularCardList.add(PopularHelper(R.drawable.ic_dashboard_black_24dp, "Les couleurs", 4F))
        popularCardList.add(PopularHelper(R.drawable.ic_dashboard_black_24dp, "Les figures Géometriques", 3F))
